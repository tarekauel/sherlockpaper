...
\begin{lstlisting}[label={fig:array_function},caption={...},language=Javascript]
var a = [1, 2, 3, 4];
a.revere();
\end{lstlisting}
...
\begin{lstlisting}[label={fig:example_functions},language=Javascript,caption={...}]
var a = [];
a.push(1);
...
\begin{lstlisting}[label={fig:example_cond},language=Javascript,caption={...}]
var a = [1, 2, 3];
...
\begin{lstlisting}[caption={...},label=fig:example_cond_instrum,language=Javascript]
// ...
while (condition) {
    // ...
    var x = []
...
\begin{lstlisting}[language=Javascript,caption={...},label=fig:example_cond_instrum_2]
if (condition) {
  // condition level = 1
  var x = [];
}
